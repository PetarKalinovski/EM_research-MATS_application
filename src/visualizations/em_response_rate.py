...
bars = ax.bar(models, em_response_percent, color=['#2E86AB', '#A23B72'], alpha=0.8, edgecolor='black', linewidth=1)

# Customize the chart
ax.set_ylabel('Percent EM Responses', fontsize=12, fontweight='bold')
ax.set_xlabel('Models', fontsize=12, fontweight='bold')
ax.set_title('Comparison of EM Response Rates for Risky Financial Advice',
